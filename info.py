...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Ayush:<password>@cluster0.srqzvpb.mongodb.net/?retryWrites=true&w=majority")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001738180086')).split()]
